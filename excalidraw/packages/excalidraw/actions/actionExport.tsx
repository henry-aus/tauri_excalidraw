...
export const actionSaveFileToDisk = register({
  ...
  perform: async (elements, appState, value, app) => {
    try {
      ...
      if (window.__TAURI__) {
        const serialized = serializeAsJSON(elements, appState, app.files, "local");
        // appState.draw doesn't exist, it will complain about it. 
        // so use serialized save file information instead. in the response
        // we could see the ipc is processed properly.
         await invoke('download', {content: JSON.stringify(serialized)});
      } else{
